...
export default function TextFlip() {
    const words = useMemo(() => ["anytime", "anywhere", "anytime"], []);
    ...
    return (
        <div className="box-content flex gap-4 text-6xl font-semibold">
            
            <div ref={tallestRef} className="flex flex-col overflow-hidden text-[#e21d48]">
